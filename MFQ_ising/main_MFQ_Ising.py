...
np.random.seed(13)
#to interact easily with the code,  use argparse to pass the parameters
...
#avoid local optimum by using boltzman exploration
...
for i_episode in range(n_episode):
  ...
  if if_plot:
    plt.figure(2)
    plt.ion()#to draw the plot dynamically
