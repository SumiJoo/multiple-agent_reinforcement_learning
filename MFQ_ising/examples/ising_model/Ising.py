...
from examples.ising_model.multiagent.core import IsingWorld, IsingAgent


class Scenario():
  # to choose neighbors.we use one index to identify each position.you can also use two , which make the use of boundary condition easily 
